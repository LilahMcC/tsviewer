...
#' @param third `[character(5)]` Y axis for third panel.
#'
#' @export
#' @importFrom magrittr %>%
run_tsviewer <- function(df, id, tz, third) {
  ts_data <- df %>%
...
#'
#' @param ts_data data frame with columns t, depth, anorm/depth, pitch, and roll.
#'
